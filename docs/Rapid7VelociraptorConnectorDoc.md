...
<table border=1><thead><tr><th>Function</th><th>Description</th><th>Annotation and Category</th></tr></thead><tbody><tr><td>List Clients</td><td>Retrieves a list of clients from Rapid7 Velociraptor based on the input parameters you have specified. Required Permissions: READ_RESULTS</td><td>list_clients <br/>Investigation</td></tr>
...
<tr><td>List Flows</td><td>Retrieves a list of flows launched on each client from Rapid7 Velociraptor based on the input parameters you have specified. Required Permissions: READ_RESULTS</td><td>list_flows <br/>Investigation</td></tr>
...
<tr><td>List Hunts</td><td>Retrieves a list of hunts from Rapid7 Velociraptor based on the input parameters you have specified. Required Permissions: READ_RESULTS</td><td>list_hunts <br/>Investigation</td></tr>
...
</td></tr><tr><td>Count</td><td>Specify the maximum number of results, per page, that this operation should return. By default, this is set as 1000. 
</td></tr><tr><td>Offset</td><td>Specify the index of the first item to be returned by this operation. By default, this is set as 0. 
</td></tr></tbody></table>
#### Output
...
</td></tr><tr><td>Artifacts</td><td>Specify a comma-separated list of artifacts to collect.
...
</td></tr><tr><td>Org ID</td><td>Specify the org ID in which the collection will be started.
</td></tr></tbody></table>
#### Output
...
</td></tr><tr><td>Artifact</td><td>Specify artifact to retrieve in this operation.
...
</td></tr><tr><td>Description</td><td>Specify the description of the hunt.
</td></tr><tr><td>Expiry Time</td><td>Specify a time for expiry. If the expiry time is in the past, the hunt will not be created.
...
</td></tr><tr><td>Count</td><td>Specify the maximum number of results, per page, that this operation should return.
</td></tr><tr><td>Offset</td><td>Specify the index of the first item to be returned by this operation.
</td></tr></tbody></table>
#### Output
...
</td></tr><tr><td>Brief</td><td>Select the checkbox to return less columns.
</td></tr></tbody></table>
#### Output
...
</td></tr><tr><td>Only Combined</td><td>Select the checkbox to only export combined results.
</td></tr><tr><td>Wait</td><td>Select the checkbox to wait for the download to complete before returning.
...
#### Input parameters
<table border=1><thead><tr><th>Parameter</th><th>Description</th></tr></thead><tbody><tr><td>VQL Query</td><td>Specify the VQL query to run on Rapid7 Velociraptor.
</td></tr></tbody></table>
#### Output
